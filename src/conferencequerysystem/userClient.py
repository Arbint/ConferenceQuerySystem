...
class App:
    ...
    def ShowMainGreeting(self):
        ...
        st.write("Thank you for joining UPGRADE Conference 2025!")
        st.write("Join the scavenger hunt by visiting the booths and scanning the QR codes provided at each booth.")
